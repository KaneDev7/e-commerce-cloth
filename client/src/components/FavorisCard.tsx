...
export default function FavorisCard({ product }) {
    ...
    return (
        ...
        <>
            <p>
                {isAddToCartClicked && <ToastContainer onClose={handleToastClose} />}
            </p>

            <div className={`max-w-[700px] w-full relative flex  duration-500 card bg-white  shadow-md`}>
                <img
                ...
                <div className='flex items-center flex-wrap gap-4  absolute bottom-2 right-2 z-20'>
