            ...
            <div className='w-full  grid category'>
                {
                    categories.map((categorie, index) => (
                        ...
                        <Link to={`/products/${categorie.id}`}> <button className='min-w-[100px] w-fit h-[40px]  px-2 text-white font-normal bg-primaryColor hover:bg-primaryColorActif hover:text-white absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-sm '>
